...
* To build this project in 2024 with a Ubuntu 24.04 please run the follwing:
* `mvn clean install -DskipTests -T1C -Doverwrite -DargLine="--add-exports jdk.compiler/com.sun.tools.javac.parser=ALL-UNNAMED" -Dspotless.check.skip=true`
